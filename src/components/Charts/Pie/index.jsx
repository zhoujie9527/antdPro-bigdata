          ...
          <div className={styles.chart}>
            ...
            {(subTitle || total) && (
              <div className={styles.total}>
                {subTitle && <h4 style={{color: fontColor || ""}}>{subTitle}</h4>}
          ...
          <ul className={styles.legend}>
            {legendData.map((item, i) => (
              <li key={item.x} onClick={() => this.handleLegendClick(item, i)}>
                ...
                />
                <span className={styles.legendTitle} style={{color: fontColor || ""}}>{item.x}</span>
                <Divider type="vertical" />
                <span className={styles.percent} style={{color: fontColor || ""}}>
